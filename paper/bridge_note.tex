...
with conjectured asymptote
$\lambda_{\infty}\!=\!3/8\!=\!(d{-}1)/(2d)$, empirically certified
at $1.0\%$ relative residual but \emph{not} analytically
discharged; (ii)~the discharge-table implication
